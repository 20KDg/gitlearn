  ...
  <div class="headbar" :style="{'background':themeColor}"  
    ...
    <span class="navbar">
      <el-menu :default-active="activeIndex" class="el-menu-demo" 
        ...
        <el-menu-item index="1" @click="$router.push('/')">文档</el-menu-item>
        <el-menu-item index="2" @click="openWindow('https://gitee.com/liuge1988/kitty/wikis/Home')">博客</el-menu-item>
        <el-menu-item index="3" @click="openWindow('https://www.cnblogs.com/xifengxiaoma/')">论坛</el-menu-item>
      </el-menu>
    </span>
    <!-- 工具栏 -->
    <span class="toolbar">
