...
import com.learn.system.security.JwtAuthenticatioToken;
...
public class LoginController {
    ...
    public ResponseEntity<Map<String, Object>> login(@RequestBody User loginBean, HttpServletRequest request) throws Exception {
        Map map = new HashMap();
